                                ...
                                <div className="col-md-4">
                                    ...
                                    <ul className="contact-detail">
                                        <li>
                                            ...
                                            <address style={{ paddingLeft: '2em', paddingTop: '0.4em' }}>
                                                <span>PT Mootix APP</span> <br />
                                                Ragunan, Jakarta Selatan
                                            </address>
                                        </li>
                                        <li>
                                        <i className="bi bi-telephone"></i>
                                            <Link style={{ paddingLeft: '0.8em' }} to="tel:+61590912831"> +61 590 912 831</Link>
                                        </li>
                                        <li>
                                        <i className="bi bi-envelope-open-heart-fill"></i>
                                            <Link style={{ paddingLeft: '1em' }} to="mailto:mootix@gmail.com">mootix@gmail.com</Link>
                                        </li>
                                    </ul>
